<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Timetable.aspx.vb" EnableEventValidation="false" Inherits="Attendance_Timetable" %>
...
<body>
         ...
         <asp:ListItem >2021</asp:ListItem>
                    ...
                    <td width="35%"></td>
                       ...
                       <div class="row mt-1">
                          ...
                          <td width="33%">
                       <asp:DropDownList ID="Ddlsectionn" AutoPostBack="true" Width="100%" runat="server" 
    OnSelectedIndexChanged="Ddlsectionn_SelectedIndexChanged">
</asp:DropDownList>
                          ...
                          <td width="33%" >
                          &nbsp 
                              <asp:Label ID="Lblsemyear" runat="server" Text="Section"></asp:Label>
                          </td>
                          ...
                          <td width="30%" align="right">
                           <asp:Label ID="Label3" runat="server" Text="Search: " hidden=true></asp:Label>&nbsp
                          </td>
                          <td width="66%">
                              <asp:TextBox ID="txtsearch" Placeholder="Search by Subject" hidden=true AutoPostBack="true" class="form-control" runat="server"></asp:TextBox>
                          </td>
    ...
    <small>
        <strong>Instructions <i class="fa-solid fa-circle-info"></i>:</strong>
                ...
                <i class="fa-solid fa-star" style="color: #1ed085;"></i> Here you Are Able to make timetable for perticuler "Class" And "Section".
                          ...
                          <div class="custom-scrollbar-css">
                            ...
                            <asp:GridView ID="gridsection" GridLines="Both" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="Classesid" ItemStyle-CssClass="hiddencol" 
                        HeaderStyle-CssClass="hiddencol" DataField="ClassesID" />
        <asp:BoundField HeaderText="CourseId" ItemStyle-CssClass="hiddencol" 
                        HeaderStyle-CssClass="hiddencol" DataField="CourseID" />
        ...
        <asp:TemplateField HeaderText="Time table">
            <ItemTemplate>
                <asp:LinkButton ID="namelink" runat="server" CommandName="Timetable"
                                CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' 
                                CssClass="SubjectName">
