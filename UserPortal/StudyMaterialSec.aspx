<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudyMaterialSec.aspx.vb" Inherits="UserPortal_StudyMaterialSec" %>
...
<body>
   ...
   <div class="card-body p-2">
    ...
    <td width="94%">
    <h5 class="enquiry">&nbsp;&nbsp;Study Materials (Subjects Enrolled)</h5>
    </td>
    </tr>
    </table>    
    </div>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    ...
                    <asp:HiddenField ID="hfAcademicYear" Value='<%# Eval("Academicyear") %>' runat="server" />

                    <a href='<%# "UnitWiseMaterial.aspx?cid=" & ViewState("Courseid") & "&subjectid=" & Eval("SubjectID") & "&acyr=" & Eval("Academicyear") %>'>
                        <%# Eval("Subject") %>
                    </a>
                </td>
                <td>
