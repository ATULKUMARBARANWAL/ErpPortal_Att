      ...
      <div class="row">
       <div class="col-md-7">
        ...
        <table width="100%">
                    <tr width="100%">
                     <td width="40%"> 
                        <asp:Label ID="Label2" class="fw-bold" runat="server" >Academic Year :</asp:Label>
                     </td>
                     <td width="2%"></td>
                     <td width="58%"> 
             ...
             <div class="card-header"><h5 class="program">Set Holiday</h5></div>
               <div class="card-body">       
                    <div class="row">
                     ...
                     <div class="row mt-2">
                       <div class="col-md-1"></div>
                           <asp:Label ID="lbl" class="col-md-4 labeltext" runat="server">Date :</asp:Label>
                        <div class="col-md-6">
                          <table width="100%">
                            <tr width="100%">
                              <td width="45%"> 
                      ...
                      <div class="row mt-2">
                       ...
                       <div class="row mt-2">
                        ...
                        <asp:Button ID="btnupdate" class="btn Submit" Visible="false" runat="server" Text="Update"></asp:Button>               
                         ...
                         <asp:Button ID="btnclear" class="btn Clear" Visible="true" runat="server" Text="Clear"></asp:Button>               
                         </div>
                       </div>  
       ...
       <asp:Panel ID="Panel1" runat="server" ScrollBars="auto" Visible="true">
        ...
        <ItemTemplate>
           ...
           <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText=" Delete">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnDelete" CommandName="Delete" CausesValidation="False" ImageUrl="~/img/url.png" Width="17px" OnClientClick="return confirm('Are you sure you want to delete?')" runat="server" />
                    </ItemTemplate>
