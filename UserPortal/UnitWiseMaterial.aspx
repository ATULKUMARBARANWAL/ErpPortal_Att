<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UnitWiseMaterial.aspx.vb" Inherits="UserPortal_UnitWiseMaterial" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">   
<title>Study Materials (Unit Wise)</title>
<meta charset="utf-8">
...
<body>
   ...
   <div class="card-body p-2">
    ...
    <td width="94%">
    <h5 class="enquiry">&nbsp;&nbsp;Study Materials (Unit Wise)</h5>
    </td>
    </tr>
    </table>    
    </div>
    ...
    <div class="row mt-2">
    <div class="col-md-12">
            <asp:Panel ID="pnlUnits" runat="server" Visible="true" ScrollBars="Auto">
    <asp:Repeater ID="rptUnits" runat="server">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Documents/Videos</th> <!-- New column for Documents/Videos -->
                    </tr>
                </thead>
                <tbody>
        </HeaderTemplate>
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <!-- Use a LinkButton to trigger navigation -->
                    <asp:LinkButton ID="btnAttachment" runat="server" CssClass="text-success" CommandArgument='<%# Eval("Subunitid") %>' OnClick="btnAttachment_Click">
                        <i class="fa fa-paperclip"></i> <!-- Green attachment icon -->
                    </asp:LinkButton>
                </td>
            </tr>
        </ItemTemplate>
