<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rabastring.aspx.vb" Inherits="Examinationjune_rabastring" %>
...
<body>
    ...
    <div class="row">
                    ...
                    <td width="80%">
                       &nbsp <asp:Label ID="LblStName" class="heading" runat="server" Text="Generate Report"></asp:Label> 
                    ...
                    <td width="15%" align="right">
                        ...
                        Program : &nbsp
                         ...
                         <td width="5%">
                         &nbsp    <asp:LinkButton ID="Download" runat="server" CssClass="DownloadExcel"> <i class="fa fa-download fa-2"></i></asp:LinkButton>
 ...
 <div class="line mb-2"></div>
                               ...
                               <div class="col-md-12 text-center">
                                   <asp:LinkButton ID="btnraba" runat="server" CssClass="btn Submit1">Raba Sheet</asp:LinkButton>
                                    <%--<asp:LinkButton class="nav-item nav-link active" ID="navactivity1" runat="server">Raba Sheet</asp:LinkButton>--%>
                                  
                                    <asp:LinkButton ID="btnfoil" runat="server" CssClass="btn Submit1">Foil Sheet</asp:LinkButton>
                                   
                                    <asp:LinkButton ID="btntheory" runat="server" CssClass="btn Submit1">Practical-Attendance Sheet</asp:LinkButton>
                                   
                                    <asp:LinkButton ID="btnattendence" runat="server" CssClass="btn Submit1">Theory-Attendence Sheet</asp:LinkButton>
                                    </div>
                                    </div> 
                                     
                                     <div class="row mt-3">
                                <div class="col-md-12">
                                <div runat="server" class="custom-scrollbar-css" id="d">
                ...
                <Columns>
                  ...
                  <ItemTemplate>
                   ...
                   <asp:BoundField HeaderText="Courseexamid" DataField="CourseExamid" ItemStyle-Width="0px" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" ReadOnly="true"></asp:BoundField> 
           <asp:BoundField HeaderText="Examname" DataField="ExamName" ItemStyle-Width="0px" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" ReadOnly="true"></asp:BoundField> 

                 <asp:BoundField HeaderText="Program" DataField="Course" ItemStyle-Width="0px" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField> 
                 
                         <asp:BoundField HeaderText="Stuid" DataField="StudentID" ItemStyle-Width="0px" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" ReadOnly="true"></asp:BoundField>
                         <asp:BoundField HeaderText="StuName" DataField="Student" ItemStyle-Width="0px" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" ReadOnly="true"></asp:BoundField>
         ...
         <asp:BoundField HeaderText="Semester/Year" DataField="Semyear"></asp:BoundField>
                    ...
                    <asp:BoundField HeaderText="DOB" DataField="Dateofbirth"></asp:BoundField>
                        <asp:BoundField HeaderText="Father's Name" DataField="FatherName"></asp:BoundField>
                                     <asp:BoundField HeaderText="Email" DataField="Email"></asp:BoundField>
                                         ...
                                         <asp:BoundField HeaderText="Mobile" DataField="Email"></asp:BoundField>                
                            ...
                            <div class="row">
                                   <div class="col-md-12">
                                       ...
                                       <div class="col-md-12 d-flex justify-content-between">
                                           ...
                                           <asp:ImageButton ID="bntdocprint" ImageUrl="~/img/pr1.png" runat="server" Width="40px" Height="40px" />  
                                       </div>
                                       </div>
