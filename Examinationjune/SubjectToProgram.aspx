<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SubjectToProgram.aspx.vb" EnableEventValidation = "false" Inherits="Templates_SubjectToProgram" %>
    ...
    <asp:Panel ID="PanelCourseWise" runat="server" Visible="True">
     ...
     <div class="container-fluid maincontainer mt-2">
         ...
         <asp:ListItem >2021</asp:ListItem>
             ...
             <hr />
             <asp:Panel ID="PnlProgramsubjectlist" Visible="True" runat="server">
                       <div class="row mt-3">
                          <div class="col-md-12">
                          ...
                          <div class="custom-scrollbar-css">
                          	<div style="margin-bottom:12px;">
                                           <small>Instructions <i class="fa-solid fa-circle-info"></i> :-
                                                <i class="fa-solid fa-star" style="color: #1ed085;"></i>Add Subject by clicking "Map Subject".
                                                <i class="fa-solid fa-star" style="color: #1ed085;"></i>You are able to delete Subject by clicking "X". 
                        
                                            </small>
                                        </div>
                            <asp:GridView ID="gridallsubject" GridLines="Both"  Width="100%"  DataKeyNames="SubjectId,Subject,Coursesubid"
                    ...
                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'  Width="20px" OnClientClick="return confirm('Really!Do u want to Delete')" runat="server" />
                       ...
                       <div class="row">
                                 <div class="col-md-12 text-end">
                                     ...
                                     <asp:LinkButton ID="btnAddsubject" runat="server" class="addsubject">Map Subject</asp:LinkButton>
                      </div>
                      </div>
                      </asp:Panel>

                      <asp:Panel ID="PnlallSubjectlis" Visible="false" runat="server">
                       <div class="row mt-3">
                          ...
                          <div style="margin-bottom:12px;">
                                           <small>Instructions <i class="fa-solid fa-circle-info"></i> :-
                                                <i class="fa-solid fa-star" style="color: #1ed085;"></i>Add Subject from existing Subject by Selecting Checkbox and clicking On "Save".
                                                <i class="fa-solid fa-star" style="color: #1ed085;"></i>You are able to Add New Subject By Clicking on button"+Subject". 
                        
                                            </small>
                                        </div>
                            <asp:GridView ID="GridMapSubject" GridLines="Both"  Width="100%"  DataKeyNames="SubjectId"
                           AutoGenerateColumns="False" runat="server" CellPadding="0" 
                         ...
                         <asp:CheckBox ID="btnselect" runat="server" />
                          ...
                          <asp:BoundField HeaderText="Subjectid" ItemStyle-Width="0px"  DataField="Subjectid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" ReadOnly="true"></asp:BoundField>           
              ...
              <asp:BoundField HeaderText="Subject Name"  DataField="Subject" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                          ...
                          CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' CssClass="SubjectName"></asp:LinkButton>       
                           ...
                           <asp:BoundField HeaderText="Subject Prefix" DataField="Subprefix"></asp:BoundField>
                           <asp:BoundField HeaderText="Subject type" DataField="Subtype"></asp:BoundField>     
           ...
           <div class="modal-body">
                    <div class="col-md-3;right:15px;"style="margin-bottom:10px;">
                                                               <small > Instructions !
                                                                    <i class="fa-solid fa-star" style="color: #1ed085;"></i> Please Fill the Feilds And Clicking on "Save". 
                                                                    <i class="fa-solid fa-star" style="color: #1ed085;"></i>This form is for adding new Subject.</br>   
