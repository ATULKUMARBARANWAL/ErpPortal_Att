...
Partial Class UserPortal_QuizSubjectList
    ...
    Protected Sub rptSubjects_ItemCommand(ByVal sender As Object, ByVal e As RepeaterCommandEventArgs)
        If e.CommandName = "Select" Then
            ' Save the SubjectID in the session
            Session("SubjectID") = e.CommandArgument.ToString()

            ' Redirect to the QuizzesList.aspx page
