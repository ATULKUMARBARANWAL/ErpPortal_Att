<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Facultyfeedback.aspx.vb" Inherits="Examinationjune_Facultyfeedback" %>
         ...
         <asp:ListItem >2021</asp:ListItem>
             ...
             <asp:Panel ID="PnlProgramsubjectlist" Visible="True" runat="server">
                       <div class="row mt-3">
                          ...
                          <div class="custom-scrollbar-css">
                            ...
                            <asp:GridView ID="gridallsubject" GridLines="Both"  Width="100%"  DataKeyNames="SubjectId,Courseid,Facultyid,Classesid"
                         ...
                         <asp:BoundField HeaderText="Subject Code" DataField="Subjectcode"></asp:BoundField>
                          ...
                          CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' CssClass="SubjectName"></asp:LinkButton>       
                           ...
                           <asp:BoundField HeaderText="Sem/Year" DataField="Semyear"></asp:BoundField> 
                             <asp:BoundField HeaderText="Faculty" DataField="Employee"></asp:BoundField>
                             <asp:BoundField HeaderText="Section" DataField="Code"></asp:BoundField>
                             <asp:TemplateField HeaderText="View Feedback" >
                   <ItemTemplate>
                   <asp:LinkButton ID="assignlink1" runat="server" CommandName="viewassignment" 
             CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' CssClass="SubjectName"><i class="fa-solid fa-eye"></i></asp:LinkButton>
                       ...
                       <div class="row">
                                 ...
                                 <asp:LinkButton ID="btnelectsub" runat="server" class="addsubject">Elective Subject</asp:LinkButton>
