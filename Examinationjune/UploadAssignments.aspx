<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadAssignments.aspx.vb" Inherits="Examinationjune_UploadAssignments" %>
             ...
             <div class="col-md-12">
                 <nav>
                                   <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <asp:LinkButton class="nav-item nav-link active" ID="lbtnDoc" runat="server">Assignment Document</asp:LinkButton>
                                     </div>
                                </nav>
             </div>
         </div>
