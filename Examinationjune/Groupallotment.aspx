<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Groupallotment.aspx.vb" Inherits="Examinationjune_Groupallotment" %>
    ...
    <asp:Panel ID="pnlhead" Visible="True"   runat="server">
     <div class="container-fluid">
       ...
       <div class="row justify-content-center mt-1">
        ...
        &nbsp
            <h5 class="program">
                <asp:Label ID="lbl" runat="server" Text="Group Allotment"></asp:Label></h5>
