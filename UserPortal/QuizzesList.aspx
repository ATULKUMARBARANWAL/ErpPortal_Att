<%@ Page Language="VB" AutoEventWireup="false" CodeFile="QuizzesList.aspx.vb" Inherits="UserPortal_QuizzesList" %>
...
<body>
   ...
   <div class="card-body p-2">
    ...
    <div class="row mt-2">
    <div class="col-md-12">
<asp:Panel ID="pnlQuizzes" runat="server" Visible="true" ScrollBars="Auto">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <%-- Check if QuestionCount is greater than 0 --%>
                <asp:Panel ID="pnlActions" runat="server" Visible='<%# Eval("QuestionCount") > 0 %>'>
                    <asp:Button ID="btnStartQuiz" runat="server" CssClass="btn" Text="Start Quiz"
                                CommandArgument='<%# Eval("QuizID") %>' 
                                Visible='<%# Not HasPreviousAttempt(Eval("QuizID").ToString()) %>'
                                OnClick="StartQuiz_Click" />

                    <asp:Button ID="btnPreview" runat="server" CssClass="btn btn-info" Text="Preview" 
                                CommandArgument='<%# Eval("QuizID") %>'
                                Visible='<%# HasPreviousAttempt(Eval("QuizID").ToString()) %>'
                                OnClick="PreviewQuiz_Click" style="width:65%;"/>
                </asp:Panel>

                <%-- Display "Not Permitted" in red if QuestionCount is 0 --%>
                <asp:Label ID="lblNotPermitted" runat="server" Text="Not Permitted" ForeColor="Red" 
                           Visible='<%# Eval("QuestionCount").ToString() = "0" %>'></asp:Label>
            </td>
        </tr>
    </ItemTemplate>
    <FooterTemplate>
